						...
						<div className={styles.Box}>
							<div className={styles.Contacts}>
								<span className={styles.Item}>
									<Icon name="clock" size="20" className={styles.ItemIcon} />
									ПН-ВС 10:00 - 21:00
								</span>
								<a
									className={classnames(styles.Item, styles.Item_hovarable)}
									href="mailto:iris9009797@yandex.ru"
								>
									<Icon name="mail" className={styles.ItemIcon} size="20" />
									ris9009797@yandex.ru
								</a>
								<a
									className={classnames(styles.Item, styles.Item_hovarable)}
									href="tel:+74999009797"
								>
									<Icon name="call" className={styles.ItemIcon} size="20" />
									+7(499) 900-97-97
								</a>
							</div>
